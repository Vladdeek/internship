	...
	return (
		<>
			<div className='AccordCon4Comp grid grid-cols-12 text-center text-sm'>
				<div className='grid lg:col-span-11 col-span-10 lg:grid-cols-6 grid-cols-3 items-center'>
					<p className='lg:col-span-1 col-span-1 order-1'>{text1}</p>
					<div className='lg:col-span-3 col-span-4 order-4'>
						<p>{text2_1}</p>
						<p>{text2_2}</p>
					</div>
					<p className='lg:col-span-1 col-span-1 order-2'>{text3}</p>
					<p className='lg:col-span-1 col-span-1 order-3'>{text4}</p>
				</div>
