...
const AccordContent2 = ({
	...
	return (
		<div className='grid gap-x-3 lg:grid-cols-4 grid-cols-4 w-full p-5'>
			<div className='relative lg:col-span-4 col-span-4'>
			...
			<div className='lg:col-span-1 flex flex-col col-span-2'>
			...
			<div className='relative lg:col-span-3 col-span-4'>
